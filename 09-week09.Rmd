...
This week we will dive a little deeper into creating web maps. We will do this by looking at "the leading open-source JavaScript library for mobile-friendly interactive maps": [Leaflet.js](https://leafletjs.com/). Morevoer, the lecture videos this week are provided by the best mapmaker at UCL: [Oliver O'Brien](https://oobrien.com/). Ollie is a senior research associate at the UCL Department of Geography’s Geospatial Analytics and Computing group. He is interested in investigating and implementing new ways to visualise spatial and socioeconomic data, especially open datasets relating to transport, London and other urban areas. Ollie is also directly responsible for the creation of [DataShine](https://datashine.org.uk/) and [CDRC Maps](https://maps.cdrc.ac.uk/). He also created the official maps for the [Scottish Index of Multiple Deprivation 2020](https://simd.scot/#/simd2020/BTTTFTT/9/-4.0000/55.9000/).
