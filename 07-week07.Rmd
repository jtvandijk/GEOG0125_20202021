...
```{r 07-calculate-speed, message=FALSE, cache=TRUE, warnings=FALSE}
...
```{r 07-fill-na, warnings=FALSE, message=FALSE, cache=TRUE}
# fill missing speeds
