...
<div class="note">
Normally, this is not the end of it as there is a sequence of tests that can and should be performed to make sure the model is valid. Testing for [hetersokedaticity](https://en.wikipedia.org/wiki/Heteroscedasticity) and [stochastic trends](https://otexts.com/fpp2/stochastic-and-deterministic-trends.html) for instance
</div>
